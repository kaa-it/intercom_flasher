...
class QComboBox(PySide6.QtWidgets.QWidget):
    ...
    AdjustToMinimumContentsLengthWithIcon: QComboBox = ... # 0x2
...
class QDialogButtonBox(PySide6.QtWidgets.QWidget):
    ...
    AndroidLayout            : QDialogButtonBox = ... # 0x4
...
class QFileDialog(PySide6.QtWidgets.QDialog):
    ...
    DontUseNativeDialog      : QFileDialog = ... # 0x8
    ReadOnly                 : QFileDialog = ... # 0x10
    HideNameFilterDetails    : QFileDialog = ... # 0x20
    DontUseCustomDirectoryIcons: QFileDialog = ... # 0x40
...
class QGraphicsView(PySide6.QtWidgets.QAbstractScrollArea):
    ...
    IndirectPainting         : QGraphicsView = ... # 0x4
...
class QStyle(PySide6.QtCore.QObject):
    ...
    SE_LabelLayoutItem       : QStyle = ... # 0x23
    ...
    SE_ProgressBarLayoutItem : QStyle = ... # 0x24
    ...
    SE_PushButtonLayoutItem  : QStyle = ... # 0x25
    ...
    SE_RadioButtonLayoutItem : QStyle = ... # 0x26
    ...
    SE_SliderLayoutItem      : QStyle = ... # 0x27
    ...
    SE_SpinBoxLayoutItem     : QStyle = ... # 0x28
    ...
    SE_ToolButtonLayoutItem  : QStyle = ... # 0x29
    ...
    SE_FrameLayoutItem       : QStyle = ... # 0x2a
    ...
    SE_GroupBoxLayoutItem    : QStyle = ... # 0x2b
    ...
    SE_TabWidgetLayoutItem   : QStyle = ... # 0x2c
    ...
    SE_ItemViewItemDecoration: QStyle = ... # 0x2d
    ...
    SE_ItemViewItemText      : QStyle = ... # 0x2e
    ...
    SE_ItemViewItemFocusRect : QStyle = ... # 0x2f
    ...
    SE_TabBarTabLeftButton   : QStyle = ... # 0x30
    ...
    PM_FocusFrameHMargin     : QStyle = ... # 0x41
    SH_Slider_PageSetButtons : QStyle = ... # 0x41
    SP_MediaSkipBackward     : QStyle = ... # 0x41
    PM_ToolTipLabelFrameWidth: QStyle = ... # 0x42
    SH_Menu_KeyboardSearch   : QStyle = ... # 0x42
    SP_MediaSeekForward      : QStyle = ... # 0x42
    PM_CheckBoxLabelSpacing  : QStyle = ... # 0x43
    SH_TabBar_ElideMode      : QStyle = ... # 0x43
    SP_MediaSeekBackward     : QStyle = ... # 0x43
    PM_TabBarIconSize        : QStyle = ... # 0x44
    SH_DialogButtonLayout    : QStyle = ... # 0x44
    SP_MediaVolume           : QStyle = ... # 0x44
    PM_SizeGripSize          : QStyle = ... # 0x45
    SH_ComboBox_PopupFrameStyle: QStyle = ... # 0x45
    SP_MediaVolumeMuted      : QStyle = ... # 0x45
    PM_DockWidgetTitleMargin : QStyle = ... # 0x46
    SH_MessageBox_TextInteractionFlags: QStyle = ... # 0x46
    SP_LineEditClearButton   : QStyle = ... # 0x46
    PM_MessageBoxIconSize    : QStyle = ... # 0x47
    SH_DialogButtonBox_ButtonsHaveIcons: QStyle = ... # 0x47
    SP_DialogYesToAllButton  : QStyle = ... # 0x47
    PM_ButtonIconSize        : QStyle = ... # 0x48
    SH_MessageBox_CenterButtons: QStyle = ... # 0x48
    SP_DialogNoToAllButton   : QStyle = ... # 0x48
    PM_DockWidgetTitleBarButtonMargin: QStyle = ... # 0x49
    SH_Menu_SelectionWrap    : QStyle = ... # 0x49
    SP_DialogSaveAllButton   : QStyle = ... # 0x49
    PM_RadioButtonLabelSpacing: QStyle = ... # 0x4a
    SH_ItemView_MovementWithoutUpdatingSelection: QStyle = ... # 0x4a
    SP_DialogAbortButton     : QStyle = ... # 0x4a
    PM_LayoutLeftMargin      : QStyle = ... # 0x4b
    SH_ToolTip_Mask          : QStyle = ... # 0x4b
    SP_DialogRetryButton     : QStyle = ... # 0x4b
    PM_LayoutTopMargin       : QStyle = ... # 0x4c
    SH_FocusFrame_AboveWidget: QStyle = ... # 0x4c
    SP_DialogIgnoreButton    : QStyle = ... # 0x4c
    PM_LayoutRightMargin     : QStyle = ... # 0x4d
    SH_TextControl_FocusIndicatorTextCharFormat: QStyle = ... # 0x4d
    SP_RestoreDefaultsButton : QStyle = ... # 0x4d
    PM_LayoutBottomMargin    : QStyle = ... # 0x4e
    SH_WizardStyle           : QStyle = ... # 0x4e
    PM_LayoutHorizontalSpacing: QStyle = ... # 0x4f
    SH_ItemView_ArrowKeysNavigateIntoChildren: QStyle = ... # 0x4f
    PM_LayoutVerticalSpacing : QStyle = ... # 0x50
    SH_Menu_Mask             : QStyle = ... # 0x50
    PM_TabBar_ScrollButtonOverlap: QStyle = ... # 0x51
    SH_Menu_FlashTriggeredItem: QStyle = ... # 0x51
    PM_TextCursorWidth       : QStyle = ... # 0x52
    SH_Menu_FadeOutOnHide    : QStyle = ... # 0x52
    PM_TabCloseIndicatorWidth: QStyle = ... # 0x53
    SH_SpinBox_ClickAutoRepeatThreshold: QStyle = ... # 0x53
    PM_TabCloseIndicatorHeight: QStyle = ... # 0x54
    SH_ItemView_PaintAlternatingRowColorsForEmptyArea: QStyle = ... # 0x54
    PM_ScrollView_ScrollBarSpacing: QStyle = ... # 0x55
    SH_FormLayoutWrapPolicy  : QStyle = ... # 0x55
    PM_ScrollView_ScrollBarOverlap: QStyle = ... # 0x56
    SH_TabWidget_DefaultTabPosition: QStyle = ... # 0x56
    PM_SubMenuOverlap        : QStyle = ... # 0x57
    SH_ToolBar_Movable       : QStyle = ... # 0x57
    PM_TreeViewIndentation   : QStyle = ... # 0x58
    SH_FormLayoutFieldGrowthPolicy: QStyle = ... # 0x58
    PM_HeaderDefaultSectionSizeHorizontal: QStyle = ... # 0x59
    SH_FormLayoutFormAlignment: QStyle = ... # 0x59
    PM_HeaderDefaultSectionSizeVertical: QStyle = ... # 0x5a
    SH_FormLayoutLabelAlignment: QStyle = ... # 0x5a
    PM_TitleBarButtonIconSize: QStyle = ... # 0x5b
    SH_ItemView_DrawDelegateFrame: QStyle = ... # 0x5b
    PM_TitleBarButtonSize    : QStyle = ... # 0x5c
    SH_TabBar_CloseButtonPosition: QStyle = ... # 0x5c
    SH_DockWidget_ButtonsHaveFrame: QStyle = ... # 0x5d
    SH_ToolButtonStyle       : QStyle = ... # 0x5e
    SH_RequestSoftwareInputPanel: QStyle = ... # 0x5f
    SH_ScrollBar_Transient   : QStyle = ... # 0x60
    SH_Menu_SupportsSections : QStyle = ... # 0x61
    SH_ToolTip_WakeUpDelay   : QStyle = ... # 0x62
    SH_ToolTip_FallAsleepDelay: QStyle = ... # 0x63
    SH_Widget_Animate        : QStyle = ... # 0x64
    SH_Splitter_OpaqueResize : QStyle = ... # 0x65
    SH_ComboBox_UseNativePopup: QStyle = ... # 0x66
    SH_LineEdit_PasswordMaskDelay: QStyle = ... # 0x67
    SH_TabBar_ChangeCurrentDelay: QStyle = ... # 0x68
    SH_Menu_SubMenuUniDirection: QStyle = ... # 0x69
    SH_Menu_SubMenuUniDirectionFailCount: QStyle = ... # 0x6a
    SH_Menu_SubMenuSloppySelectOtherActions: QStyle = ... # 0x6b
    SH_Menu_SubMenuSloppyCloseTimeout: QStyle = ... # 0x6c
    SH_Menu_SubMenuResetWhenReenteringParent: QStyle = ... # 0x6d
    SH_Menu_SubMenuDontStartSloppyOnLeave: QStyle = ... # 0x6e
    SH_ItemView_ScrollMode   : QStyle = ... # 0x6f
    SH_TitleBar_ShowToolTipsOnButtons: QStyle = ... # 0x70
    SH_Widget_Animation_Duration: QStyle = ... # 0x71
    SH_ComboBox_AllowWheelScrolling: QStyle = ... # 0x72
    SH_SpinBox_ButtonsInsideFrame: QStyle = ... # 0x73
    SH_SpinBox_StepModifier  : QStyle = ... # 0x74
...
class QStyleOptionDockWidget(PySide6.QtWidgets.QStyleOption):
    Version                  : QStyleOptionDockWidget = ... # 0x1
...
class QStyleOptionProgressBar(PySide6.QtWidgets.QStyleOption):
    Version                  : QStyleOptionProgressBar = ... # 0x1
...
class QStyleOptionTabBarBase(PySide6.QtWidgets.QStyleOption):
    Version                  : QStyleOptionTabBarBase = ... # 0x1
...
class QStyleOptionTabWidgetFrame(PySide6.QtWidgets.QStyleOption):
    Version                  : QStyleOptionTabWidgetFrame = ... # 0x1
...
class QStyleOptionToolBox(PySide6.QtWidgets.QStyleOption):
    ...
    Version                  : QStyleOptionToolBox = ... # 0x1
...
class QStyleOptionViewItem(PySide6.QtWidgets.QStyleOption):
    ...
    Version                  : QStyleOptionViewItem = ... # 0x1
