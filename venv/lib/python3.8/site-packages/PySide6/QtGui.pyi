...
class QAbstractFileIconProvider(Shiboken.Object):
    Computer                 : QAbstractFileIconProvider = ... # 0x0
    Desktop                  : QAbstractFileIconProvider = ... # 0x1
    DontUseCustomDirectoryIcons: QAbstractFileIconProvider = ... # 0x1
    Trashcan                 : QAbstractFileIconProvider = ... # 0x2
    Network                  : QAbstractFileIconProvider = ... # 0x3
    Drive                    : QAbstractFileIconProvider = ... # 0x4
    Folder                   : QAbstractFileIconProvider = ... # 0x5
    File                     : QAbstractFileIconProvider = ... # 0x6
...
class QColorSpace(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, primaries:PySide6.QtGui.QColorSpace.Primaries, fun:PySide6.QtGui.QColorSpace.TransferFunction, gamma:float=...) -> None: ...
    @typing.overload
    def __init__(self, primaries:PySide6.QtGui.QColorSpace.Primaries, gamma:float) -> None: ...
    @typing.overload
    def __init__(self, whitePoint:PySide6.QtCore.QPointF, redPoint:PySide6.QtCore.QPointF, greenPoint:PySide6.QtCore.QPointF, bluePoint:PySide6.QtCore.QPointF, fun:PySide6.QtGui.QColorSpace.TransferFunction, gamma:float=...) -> None: ...
...
class QEventPoint(Shiboken.Object):
    Unknown                  : QEventPoint = ... # 0x0
    Pressed                  : QEventPoint = ... # 0x1
    Updated                  : QEventPoint = ... # 0x2
    Stationary               : QEventPoint = ... # 0x4
    Released                 : QEventPoint = ... # 0x8
...
class QFont(Shiboken.Object):
    ...
    ExtraLight               : QFont = ... # 0xc8
    UltraExpanded            : QFont = ... # 0xc8
    NoAntialias              : QFont = ... # 0x100
    Light                    : QFont = ... # 0x12c
    Normal                   : QFont = ... # 0x190
    Medium                   : QFont = ... # 0x1f4
    DemiBold                 : QFont = ... # 0x258
    Bold                     : QFont = ... # 0x2bc
    ExtraBold                : QFont = ... # 0x320
    Black                    : QFont = ... # 0x384
...
class QKeyCombination(Shiboken.Object):
    ...
    @staticmethod
    def fromCombined(combined:int) -> PySide6.QtGui.QKeyCombination: ...
...
class QKeyEvent(PySide6.QtGui.QInputEvent):
    ...
    def key(self) -> int: ...
    def keyCombination(self) -> PySide6.QtGui.QKeyCombination: ...
...
class QKeySequence(Shiboken.Object):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, k1:PySide6.QtGui.QKeyCombination, k2:PySide6.QtGui.QKeyCombination=..., k3:PySide6.QtGui.QKeyCombination=..., k4:PySide6.QtGui.QKeyCombination=...) -> None: ...
    @typing.overload
...
class QMatrix4x4(Shiboken.Object):
    Identity                 : QMatrix4x4 = ... # 0x0
    Translation              : QMatrix4x4 = ... # 0x1
    Scale                    : QMatrix4x4 = ... # 0x2
    Rotation2D               : QMatrix4x4 = ... # 0x4
    Rotation                 : QMatrix4x4 = ... # 0x8
    Perspective              : QMatrix4x4 = ... # 0x10
    General                  : QMatrix4x4 = ... # 0x1f
...
class QPageSize(Shiboken.Object):
    ...
    B10                      : QPageSize = ... # 0x18
    C5E                      : QPageSize = ... # 0x19
    EnvelopeC5               : QPageSize = ... # 0x19
    Comm10E                  : QPageSize = ... # 0x1a
    Envelope10               : QPageSize = ... # 0x1a
    DLE                      : QPageSize = ... # 0x1b
    EnvelopeDL               : QPageSize = ... # 0x1b
    Folio                    : QPageSize = ... # 0x1c
    AnsiB                    : QPageSize = ... # 0x1d
    Ledger                   : QPageSize = ... # 0x1d
    Tabloid                  : QPageSize = ... # 0x1e
    Custom                   : QPageSize = ... # 0x1f
...
class QPaintEngine(Shiboken.Object):
    ...
    OpenGL                   : QPaintEngine = ... # 0x6
    Picture                  : QPaintEngine = ... # 0x7
    DirtyFont                : QPaintEngine = ... # 0x8
    PatternBrush             : QPaintEngine = ... # 0x8
    SVG                      : QPaintEngine = ... # 0x8
    Raster                   : QPaintEngine = ... # 0x9
    Direct3D                 : QPaintEngine = ... # 0xa
    Pdf                      : QPaintEngine = ... # 0xb
    OpenVG                   : QPaintEngine = ... # 0xc
    OpenGL2                  : QPaintEngine = ... # 0xd
    PaintBuffer              : QPaintEngine = ... # 0xe
    Blitter                  : QPaintEngine = ... # 0xf
    Direct2D                 : QPaintEngine = ... # 0x10
...
class QPointingDevice(PySide6.QtGui.QInputDevice):
    GrabPassive              : QPointingDevice = ... # 0x1
    UngrabPassive            : QPointingDevice = ... # 0x2
    CancelGrabPassive        : QPointingDevice = ... # 0x3
    OverrideGrabPassive      : QPointingDevice = ... # 0x4
    GrabExclusive            : QPointingDevice = ... # 0x10
    UngrabExclusive          : QPointingDevice = ... # 0x20
    CancelGrabExclusive      : QPointingDevice = ... # 0x30
...
class QTextDocument(PySide6.QtCore.QObject):
    ...
    MarkdownDialectGitHub    : QTextDocument = ... # 0x4f0c
...
class QTextFormat(Shiboken.Object):
    ...
    FontLetterSpacingType    : QTextFormat = ... # 0x1fe9
    FontStretch              : QTextFormat = ... # 0x1fea
    ...
    OldTextUnderlineColor    : QTextFormat = ... # 0x2010
    TextUnderlineColor       : QTextFormat = ... # 0x2020
    ...
    TextSuperScriptBaseline  : QTextFormat = ... # 0x2025
    TextSubScriptBaseline    : QTextFormat = ... # 0x2026
    TextBaselineOffset       : QTextFormat = ... # 0x2027
    IsAnchor                 : QTextFormat = ... # 0x2030
    AnchorHref               : QTextFormat = ... # 0x2031
    AnchorName               : QTextFormat = ... # 0x2032
    OldFontLetterSpacingType : QTextFormat = ... # 0x2033
    OldFontStretch           : QTextFormat = ... # 0x2034
